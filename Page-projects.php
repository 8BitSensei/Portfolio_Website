...
<html lang="en">
    <head>
        ...
        <link rel="Stylesheet" href="Page-projects.css" />
    ...
    <body>
        <script type="text/javascript">
            ...
            function redirectToArticle(id){
                    window.location.replace("Page-article.php?art_id="+id+"&typ=project");
                }
            ...
            $(document).ready(function(){
                ...
                $('#a').click(function(){
                        window.location = 'Page-projects.php?search=latest';
                });
                  $('#b').click(function(){
                        window.location = 'Page-projects.php?search=popular';
                });
                            ...
                            <div id='tab-list'>
                                <ul style="list-style-type:none" >
                                    ...
                                    <li class='menu-tab' id='c'><div class='tags'>
                                        <a href='Page-projects.php?search=latest&tag=Web'>#Web,</a> 
                                        <a href='Page-projects.php?search=latest&tag=Security'>#Security,</a> 
                                        <a href='Page-projects.php?search=latest&tag=Hardware'>#Hardware,</a> 
                                        <a href='Page-projects.php?search=latest&tag=Virtual Reality'>#Virtual Reality</a>
                                    </div></li>
                                ...
                                echo "<div class='list-item' style='box-shadow: 0px 0px 3px #888;' onclick='redirectToArticle(".$result[$i]['id'].");'>
                                        <ul style='list-style-type:none' class='item-li'>
                                            ...
                                            foreach ($tags_array as $key) {
                                                echo"<a href='Page-projects.php?search=latest&tag=$key'>
                                                #$key,</a> ";
                                            }
